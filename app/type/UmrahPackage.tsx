export class UmrahPackage {
    ...
    static fromJson(json: any): UmrahPackage {
        return new UmrahPackage({
            ...
            is_roundtrip: Boolean(json.is_roundtrip),
            breakfast_enabled: Boolean(json.breakfast_enabled),
            ziyarat: Boolean(json.ziyarat),
            guide: Boolean(json.guide),
            transport_enabled: Boolean(json.transport_enabled),
            email: json.email || "",
            whatsapp: json.whatsapp || "",
            phone: json.phone || "",
            hotel_makkah_enabled: Boolean(json.hotel_makkah_enabled),
            hotel_madina_enabled: Boolean(json.hotel_madina_enabled),
            visa_enabled: Boolean(json.visa_enabled),
            ticket_enabled: Boolean(json.ticket_enabled),
